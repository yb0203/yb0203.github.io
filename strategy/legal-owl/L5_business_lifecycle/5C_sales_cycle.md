...
2. **Stage 2: Technical Demo & Scoping**
   - *Activity*: Demonstrate template deviation checker and court docket sync modules. Share the security package.
   - *Exit Criteria*: Agreement on a 30-day pilot scope and sign-off on the pilot agreement.
   - *Duration*: 2 - 3 weeks.

3. **Stage 3: Paid Pilot (30 Days)**
   - *Activity*: Deploy the Platform inside the bank's sandbox environment. Upload approved templates and litigation lists.
...
5. **Stage 5: Enterprise Commercial Negotiations**
   - *Activity*: Finalize seat licensing tiers, SLA response times, support terms, and pricing in USD.
   - *Exit Criteria*: Signed master services agreement (MSA) and purchase order (PO).
   - *Duration*: 2 - 4 weeks.

6. **Stage 6: Customer Success & Expansion**
   - *Activity*: Onboard the remaining legal team members; monitor usage and pitch secondary modules (e.g., Federal Policy Auditor).
   - *Exit Criteria*: Expand user seats by 50% or secure secondary module upsell.
   - *Duration*: Continuous.

## 🔑 Key Decisions / Open Questions
- [ ] Define the legal template language needed to protect the Platform's intellectual property when hosted locally on bank servers.
