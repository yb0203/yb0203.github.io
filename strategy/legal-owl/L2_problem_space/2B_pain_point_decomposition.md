...
### Detailed Pain Point Inventory
| Code | Workflow | Specific Pain Point | Who Feels It | Freq. | Severity | Current Workaround |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
| **P9** | W4 (Risk) | Inconsistent legal risk assessments across different branches and credit units | CRO | Weekly | Med | Email consults; centralized risk committee approvals |
| **P10**| W5 (Ops) | High volume of simple queries from business teams cluttering legal inbox | GC | Daily | Med | Automated generic email auto-responders |
| **P11**| W5 (Ops) | Reviewing and auditing bills submitted by external panel law firms | Legal Ops Head | Monthly | Low | Manual comparison of bills with agreed fee structures |
| **P12**| W1 (Trans) | Delay in closing commercial contracts because negotiations stall on standard liability terms | Business Head | Daily | High | Escalation calls; manual compromise drafts |
| **P13**| W2 (Reg) | Staff accessing outdated compliance templates for mortgage deeds | Compliance Manager| Weekly | High | Group emails stating "Use new version v4" |
| **P14**| W3 (Lit) | Inability to quickly find older bank precedents when handling a new suit | Litigation Manager| Weekly | Med | Searching local network drives and shared folders |
| **P15**| W4 (Risk) | High cost of external legal counsel for routine corporate advisory queries | CFO | Monthly | Med | Minimizing queries, leading to higher baseline risk |

## 🔑 Key Decisions / Open Questions
- [ ] Validate if P5 (missing court dates) is a financial risk (contempt/ex-parte orders) or just an operational headache. (Assessed as high financial and reputational risk).

## 🔗 Cross-Links
- Upstream: [L2_problem_space/2A_workflow_taxonomy.md](./2A_workflow_taxonomy.md)
- Downstream: [L2_problem_space/2C_pain_point_prioritization.md](./2C_pain_point_prioritization.md) | [L3_solution_space/3A_capability_mapping.md](../L3_solution_space/3A_capability_mapping.md)\n