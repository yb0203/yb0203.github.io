...
- Core focus (Must-haves) targets safe local deployment, eCourts tracking, and template deviations.
...
| **F2** | eCourts date scraping and email alert engine | P5 | M | **M** | MVP (Phase 1) |
...
| **F6** | Semantic search across RBI circular database | P3 | L | **S** | Phase 2 |
| **F7** | Panel Counsel billing reconciliation tool | P11 | M | **C** | Phase 3 |
| **F8** | Regional language OCR parsing (e.g., Marathi) | P5 | L | **S** | Phase 2 |
...
| **F16**| Real-time WhatsApp notifications for dates | P5 | S | **S** | Phase 2 |
| **F17**| Dynamic vector database sync with RBI portal | P3 | M | **S** | Phase 2 |
